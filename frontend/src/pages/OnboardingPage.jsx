          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <textarea
                ...
                placeholder="Write a short bio about yourself and your language goals..."
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="form-control">
                ...
                <select
                  ...
                  className="select select-bordered w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition"
                >
